    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            Pustaka
            <span style={{ color: "#4475F2" }}>Nusa</span>
          </span>
        </div>
        ...
        >
          ...
          {logs.length === 0 ? (
            ...
            logs.map((log, i) => {
              ...
              let cfg = TYPE_CONFIG.login;

              if (
                log.aktivitas?.toLowerCase().includes("baca")
              ) {
                cfg = TYPE_CONFIG.read;
              }

              else if (
                log.aktivitas?.toLowerCase().includes("unduh")
              ) {
                cfg = TYPE_CONFIG.download;
              }

              else if (
                log.aktivitas?.toLowerCase().includes("favorit")
              ) {
                cfg = TYPE_CONFIG.favorite;
              }

              else if (
                log.aktivitas?.toLowerCase().includes("cari")
              ) {
                cfg = TYPE_CONFIG.search;
              }

              else if (
                log.aktivitas?.toLowerCase().includes("profil")
              ) {
                cfg = TYPE_CONFIG.profile;
              }
